...
# SECRET_KEY = '^_4@r)_2^x45_2ku6dc(yd_^-3!q%h^ob#a8dtu7-es&oiq$#x'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '^_4@r)_2^x45_2ku6dc(yd_^-3!q%h^ob#a8dtu7-es&oiq$#x')
...
SECURE_HSTS_SECONDS = int(os.environ.get('SECURE_SSL_REDIRECT', 0))
